...
class TestDistribution(unittest.TestCase):
    ...
    def test_none(self):
        ...
        self.assertRaisesRegex(
            ValueError, ErrorMessages.WRONG_MATRIX, get_invest_distributions, None
        )
    ...
    def test_empty(self):
        ...
        качестве параметра"""
        self.assertRaisesRegex(
            ValueError, ErrorMessages.WRONG_MATRIX, get_invest_distributions, []
        )
    ...
    def test_jag(self):
        ...
        self.assertRaisesRegex(
            ValueError, ErrorMessages.WRONG_MATRIX, get_invest_distributions, matrix
        )
